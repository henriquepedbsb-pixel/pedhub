...
export default function Sepse() {
  ...
  return (
    <div style={{ fontFamily: 'DM Sans, sans-serif', maxWidth: '480px', margin: '0 auto', padding: '16px', backgroundColor: "var(--bg)", minHeight: '100vh' }}>
      ...
      <RodapeModulo
        revisao="07/2026"
        fonte="Weiss SL et al. Surviving Sepsis Campaign International Guidelines for the Management of Sepsis and Septic Shock in Children 2026. Intensive Care Med / Pediatr Crit Care Med (2026). Rodwell JD et al. J Pediatr 1988;112:761-767"
      />
    </div>
  );
}
