...
function TabHolliday({ peso }) {
  ...
  if (!peso) return (
    <div style={{ textAlign: "center", padding: "48px 16px", color: "#9CA3AF" }}>
      <Droplets size={44} color="#E5E7EB" style={{ display: "block", margin: "0 auto 10px" }} />
  ...
  return (
    <div>
      ...
      <div style={{ borderTop: "1.5px solid #E5E7EB", paddingTop: 14, marginBottom: 14 }}>
        <p style={{ fontWeight: 700, fontSize: 13, color: "#111827", margin: "0 0 10px" }}>
          Eletrólitos de Manutenção
        </p>
        ...
        <div style={{ display: "flex", gap: 6, marginBottom: 12 }}>
          {[
            ...
            <button key={op.val} onClick={() => setTipoSol(op.val)} style={{
              flex: 1, padding: "8px 6px", borderRadius: 8, border: "1.5px solid " + (tipoSol === op.val ? op.cor : "#E5E7EB"),
              background: tipoSol === op.val ? op.cor + "12" : "#F9FAFB",
              cursor: "pointer", textAlign: "center",
            }}>
              <div style={{ fontWeight: 700, fontSize: 12, color: tipoSol === op.val ? op.cor : "#374151" }}>{op.label}</div>
              <div style={{ fontSize: 10, color: tipoSol === op.val ? op.cor : "#9CA3AF", marginTop: 2 }}>{op.sub}</div>
            </button>
          ))}
        </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{ fontSize: 12, color: "#374151", fontWeight: 700 }}>Taxa de infusão</span>
        ...
        <div style={{ background: "#F9FAFB", borderRadius: 8, padding: "10px 12px", border: "1px solid #E5E7EB" }}>
          <p style={{ fontWeight: 600, fontSize: 11, color: "#374151", margin: "0 0 6px" }}>Referências clínicas</p>
          <ItemList color="#6B7280" items={[
        ...
        {tabs.map((t, i) => {
          ...
          return (
            <button key={i} onClick={() => setTab(i)} style={{
              ...
              fontWeight: active ? 700 : 500, color: active ? cores[i] : "#6B7280",
